...
**Описание:**
FastAPI — современная библиотека для создания высокопроизводительных API. Использует асинхронные возможности Python и аннотации типов для быстрого и безопасного создания API. Автоматическое создание документации
